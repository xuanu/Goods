...
public class PermissionUtils {
    ...
    public static boolean checkSelfPermissionWrapper(Object cxt, String permission) {
        if (cxt instanceof Activity) {
            ...
            Fragment fragment = (Fragment) cxt;
            return ContextCompat.checkSelfPermission(fragment.getActivity(),
                    permission) == PackageManager.PERMISSION_GRANTED;
        } else if (cxt instanceof Context) {
            return ContextCompat.checkSelfPermission((Context) cxt, permission) == PackageManager.PERMISSION_GRANTED;
        } else {
            throw new RuntimeException("cxt is net a activity or fragment");
        }
    }
